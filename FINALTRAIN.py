...
'''
            ...
            for T in trainsno:
                for a in range(len(train_nd_stationss[T])):
                    if (start and end in train_nd_stationss[T][a]):
                        f = 1
                    else:
                        f = 0
                ...
                if (f == 1):
                    ...
                    for i in range(0, len(train_nd_stationss[T])):
                        if (start == train_nd_stationss[T][a]):
                            break
                        else:
                            x += 1

                    for i in range(0, len(train_nd_stationss[T])):
                        if (end == train_nd_stationss[T][a]):
                            break
                        else:
                            y += 1
                    break
                    ...
                    print("Train no. {} doesn't travells between these two stations!".format(q))
            print(data.loc[x:y, :])
'''
